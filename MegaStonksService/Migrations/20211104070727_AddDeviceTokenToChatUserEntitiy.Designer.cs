...
namespace MegaStonksService.Migrations
{
    ...
    [Migration("20211104070727_AddDeviceTokenToChatUserEntitiy")]
    partial class AddDeviceTokenToChatUserEntitiy
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MegaStonksService.Entities.Chat.ChatMessage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("MegaStonksService.Entities.Chat.ChatSession", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("MegaStonksService.Entities.Chat.ChatUser", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("MegaStonksService.Entities.Chat.ChatMessage", b =>
                {
                    b.HasOne("MegaStonksService.Entities.Chat.ChatSession", "ChatSession")
                        .WithMany()
                        .HasForeignKey("ChatSessionId");

                    b.HasOne("MegaStonksService.Entities.Chat.ChatUser", "ChatUser")
                        .WithMany()
            ...
            modelBuilder.Entity("MegaStonksService.Entities.Chat.ChatSession", b =>
                {
                    b.HasOne("MegaStonksService.Entities.Chat.ChatUser", "User1")
                        .WithMany()
                        .HasForeignKey("User1Id");

                    b.HasOne("MegaStonksService.Entities.Chat.ChatUser", "User2")
                        .WithMany()
